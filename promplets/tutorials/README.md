...
Canonical, tested copies of the promplets built in the public tutorials under
[`docs/`](../../docs). Each tutorial page shows an abridged version of one of
these promplets and links back here so readers can run the exact source.
