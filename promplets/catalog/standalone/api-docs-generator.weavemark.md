...
Use the endpoint definitions below to create one complete endpoint section per endpoint:
...
@revise "Review for consistent terminology, complete error codes (400, 401, 403, 404, 500), accurate JSON schemas, and clear parameter descriptions."
  ...
  Overview, authentication, endpoint sections, generated examples, schemas,
  status-code tables, rate limits, and changelog entries for @{api_name}.
