...
4. **Player controls**
   - Keyboard and mouse controls as the baseline.
...
10. **Validation strategy**
   ...
   - A repeated build-run-observe-improve loop:
     ...
     4. Open the running URL with Playwright MCP and interact as a real user: click, type, drag, resize, start a level, exercise controls, trigger collisions and conversions, win or fail, pause, restart, and replay without a full page reload.
...
11. **Acceptance criteria**
   ...
   - Criteria for originality, gameplay completeness, controls, puzzle rule correctness, onboarding, accessibility, browser compatibility, persistence, and validation evidence.
