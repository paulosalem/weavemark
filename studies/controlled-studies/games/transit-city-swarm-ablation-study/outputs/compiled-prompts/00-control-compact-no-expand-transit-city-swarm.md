...
4. **Player Controls and User Experience**
...
10. **Validation Strategy**
   ...
   - Manual and visual checks for game feel, readability, responsiveness, and accessibility.
   - A playable smoke test that starts from first load, reaches active play, exercises controls and core interactions, observes scoring/progress feedback, and verifies restart or replay without a full page reload.
