# Evidence-to-Decision Workspace: Matched Reusable Template Control
...
- The product should turn messy sources into auditable claims, evidence items,
  ...
  and typed outputs.
- Initial source families: documents, PDFs, notes, meeting transcripts, pasted snippets, URLs, newsletters, GitHub issues or releases, research papers, web pages, news items, calendars, and manual observations..
