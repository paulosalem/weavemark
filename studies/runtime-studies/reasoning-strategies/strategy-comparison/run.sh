...
mkdir -p studies/runtime-studies/reasoning-strategies/strategy-comparison/outputs
...
python studies/runtime-studies/reasoning-strategies/strategy-comparison/runner.py \
  --specs \
    ...
    studies/runtime-studies/reasoning-strategies/promplets/simplified-tree-of-thought-solver.weavemark.md \
    studies/runtime-studies/reasoning-strategies/promplets/reflection-solver.weavemark.md \
  --tasks gsm8k \
  --model gpt-5.5 \
  --limit 2 \
  --parallel 2 \
  --output studies/runtime-studies/reasoning-strategies/strategy-comparison/outputs/benchmark-results.json
