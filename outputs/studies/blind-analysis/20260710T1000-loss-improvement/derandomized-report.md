...
Run: `20260710T1000-loss-improvement`
...
|---|---:|---:|
| [C1] Compact no-expand control | `B` | 5.00 |
| [C2] Matched-prose no-expand control | `A` | 4.43 |
| [T] Expanded WeaveMark treatment | `C` | 4.43 |
...
| Reusable abstraction quality | 4 | 5 | +1 |
| **Total** |  |  | **+0** |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Manual brief | `B` | 2.29 |
| [C2] Matched reusable-template control | `A` | 4.43 |
| [T] WeaveMark treatment | `C` | 6.29 |

| Criterion | Control absolute | Treatment absolute | Blind contrastive delta |
|---|---:|---:|---:|
| Authoring leverage | 4 | 7 | +2 |
| Information yield | 4 | 7 | +2 |
| Grounded expressiveness | 5 | 7 | +1 |
| Input readability | 4 | 4 | +0 |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Compact manual | `C` | 2.29 |
| [C2] Matched prose control | `B` | 3.43 |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Manual brief | `A` | 2.14 |
| [C2] Matched reusable-template control | `C` | 4.29 |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Compact no-expand control | `C` | 3.86 |
| [C2] Matched-prose no-expand control | `B` | 3.71 |
| [T] Expanded WeaveMark treatment | `A` | 5.86 |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Manual brief | `C` | 2.29 |
| [C2] Matched reusable-template control | `B` | 4.86 |
| [T] WeaveMark treatment | `A` | 6.00 |
...
Total blind contrastive delta across studies: **+69**.
