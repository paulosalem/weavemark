...
Run: `20260710T1416-iterate-final`
...
| [C2] Matched-prose no-expand control | `A` | 3.29 |
| [T] Expanded WeaveMark treatment | `C` | 6.29 |
...
| Reusable abstraction quality | 4 | 6 | +1 |
| **Total** |  |  | **+11** |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Compact manual | `C` | 1.57 |
| [C2] Matched prose control | `A` | 3.00 |
...
|---|---:|---:|
| [C1] Manual brief | `B` | 1.57 |
| [C2] Matched reusable-template control | `C` | 4.71 |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Manual request | `C` | 1.57 |
| [C2] Matched reusable-template control | `B` | 4.29 |
| [T] WeaveMark treatment | `A` | 6.00 |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Compact no-expand control | `C` | 4.00 |
| [C2] Matched-prose no-expand control | `A` | 3.29 |
...
|---|---:|---:|
| [C1] Manual brief | `A` | 1.71 |
| [C2] Matched reusable-template control | `B` | 4.71 |
...
Total blind contrastive delta across studies: **+89**.
