...
# {{game_title}}: Matched Reusable Template variant
...
definitions, ecosystem feedback loops, UI layout, variants, asset pipeline,
...

{
  ...
  "artifact_name": "Verdant Relay",
  "game_brief": "Design Verdant Relay, a browser game where the player protects a living railway garden from spreading blight. The player manages railway route pressure, habitat cells, blight trains, pests, spores, invasive vines, card-driven interventions, living defenses, ecosystem health, recovery, readability, and first-build balance."
}


## Compiled output

# Verdant Relay: Matched Reusable Template variant
...
- The first minute should teach objective, variants, primary feedback, and one
...
- Accessibility basics include readable contrast, keyboard operation, no
  ...
  text that matches implemented variants.
