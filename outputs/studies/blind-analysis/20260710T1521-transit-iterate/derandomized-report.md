...
Run: `20260710T1521-transit-iterate`
...
|---|---:|---:|
| [C1] Compact no-expand control | `C` | 3.71 |
| [C2] Matched-prose no-expand control | `A` | 3.57 |
| [T] Expanded WeaveMark treatment | `B` | 6.29 |
...
| [C2] Matched prose control | `A` | 3.14 |
...
| [C2] Matched reusable-template control | `C` | 4.43 |
| [T] WeaveMark treatment | `B` | 6.43 |
...
|---|---:|---:|
| [C1] Manual brief | `A` | 2.29 |
| [C2] Matched reusable-template control | `C` | 5.14 |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Manual request | `B` | 2.29 |
| [C2] Matched reusable-template control | `C` | 4.57 |
| [T] WeaveMark treatment | `A` | 5.71 |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Compact no-expand control | `B` | 3.71 |
| [C2] Matched-prose no-expand control | `A` | 3.57 |
| [T] Expanded WeaveMark treatment | `C` | 5.71 |
...
Total blind contrastive delta across studies: **+68**.
