...
# Crowd Factory Puzzle: variant prose No-Expand Browser Game Specification
...
9. **Validation strategy**
   ...
   - Interact as a real user: load the game, start a level, use variants, route workers, push objects, trigger belts/machines, win or fail, pause, undo or restart, and replay without a full page reload.
...
10. **Verification plan**
    ...
    - Browser smoke test from first load through active play, variants, collisions/core interactions, visible progress feedback, win/fail, and restart/replay without full page reload.
    - compact or visual checks for readability, layout stability, focus behavior, responsive sizing, and console/runtime errors.
