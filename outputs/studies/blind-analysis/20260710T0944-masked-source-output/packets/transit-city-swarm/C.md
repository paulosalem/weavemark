...
5. **Player variants and user experience**
...
12. **Verification and browser validation strategy**
    ...
    - Validation must include at least one playable smoke test from first load through active play, variants, core interaction, scoring or progress feedback, and restart or replay without a full page reload.
