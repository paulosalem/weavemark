...
Run: `20260710T0944-masked-source-output`
...
|---|---:|---:|
| [C1] Compact no-expand control | `A` | 5.57 |
| [C2] Matched-prose no-expand control | `C` | 3.57 |
| [T] Expanded WeaveMark treatment | `B` | 4.29 |

| Criterion | Control absolute | Treatment absolute | Blind contrastive delta |
|---|---:|---:|---:|
| Authoring leverage | 1 | 4 | +2 |
| Information yield | 4 | 1 | -2 |
| Grounded expressiveness | 4 | 5 | +1 |
| Input readability | 5 | 5 | +0 |
| Output readability | 5 | 5 | +0 |
| Constraint integration | 4 | 5 | +1 |
| Reusable abstraction quality | 2 | 5 | +2 |
| **Total** |  |  | **+4** |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Manual brief | `B` | 3.43 |
| [C2] Matched reusable-template control | `A` | 2.43 |
| [T] WeaveMark treatment | `C` | 6.43 |

| Criterion | Control absolute | Treatment absolute | Blind contrastive delta |
|---|---:|---:|---:|
| Authoring leverage | 4 | 7 | +2 |
| Information yield | 4 | 7 | +2 |
| Grounded expressiveness | 1 | 7 | +3 |
| Input readability | 4 | 5 | +1 |
| Output readability | 2 | 6 | +2 |
| Constraint integration | 1 | 7 | +3 |
| Reusable abstraction quality | 1 | 6 | +3 |
| **Total** |  |  | **+16** |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Compact manual | `A` | 1.57 |
| [C2] Matched prose control | `B` | 2.86 |
| [T] WeaveMark treatment | `C` | 6.57 |

| Criterion | Control absolute | Treatment absolute | Blind contrastive delta |
|---|---:|---:|---:|
| Authoring leverage | 1 | 7 | +3 |
| Information yield | 4 | 7 | +2 |
| Grounded expressiveness | 2 | 7 | +3 |
| Input readability | 6 | 5 | -1 |
| Output readability | 3 | 7 | +2 |
| Constraint integration | 2 | 7 | +3 |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Manual brief | `C` | 1.57 |
| [C2] Matched reusable-template control | `A` | 4.29 |
| [T] WeaveMark treatment | `B` | 5.86 |
...
| Input readability | 4 | 6 | +1 |
| Output readability | 5 | 6 | +1 |
| Constraint integration | 4 | 6 | +1 |
| Reusable abstraction quality | 5 | 3 | -1 |
| **Total** |  |  | **+7** |
...
| Variant | Anonymous ID | Mean absolute score |
|---|---:|---:|
| [C1] Manual request | `B` | 1.57 |
| [C2] Matched reusable-template control | `A` | 4.57 |
...
| [C2] Matched-prose no-expand control | `B` | 4.71 |
| [T] Expanded WeaveMark treatment | `C` | 4.00 |

| Criterion | Control absolute | Treatment absolute | Blind contrastive delta |
|---|---:|---:|---:|
| Authoring leverage | 4 | 1 | -2 |
| Information yield | 4 | 1 | -2 |
| Grounded expressiveness | 5 | 5 | +0 |
| Input readability | 6 | 5 | -1 |
| Output readability | 6 | 6 | +0 |
| Constraint integration | 5 | 5 | +0 |
...
|---|---:|---:|
| [C1] Manual brief | `B` | 1.57 |
| [C2] Matched reusable-template control | `C` | 6.00 |
| [T] WeaveMark treatment | `A` | 4.71 |
...
| Input readability | 5 | 4 | -1 |
| Output readability | 6 | 5 | -1 |
| Constraint integration | 7 | 4 | -2 |
| Reusable abstraction quality | 6 | 5 | -1 |
| **Total** |  |  | **-7** |

## Aggregate blind contrastive signal

Total blind contrastive delta across studies: **+56**.
